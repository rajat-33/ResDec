...
let value1 = '0', value2 = '0', value = '0', unit, v1 = 0, v2 = 0, v3 = 0, v4 = 0;
...
const App = () => {
    ...
    const changeValue = () => {
        v1 = Number(ColorValMap.get(document.getElementById('color1').style.getPropertyValue('background')));
        v2 = Number(ColorValMap.get(document.getElementById('color2').style.getPropertyValue('background')));
        v3 = Number(ColorValMap.get(document.getElementById('color3').style.getPropertyValue('background')));
        v4 = Number(ColorValMap.get(document.getElementById('color4').style.getPropertyValue('background')));
        // console.log(v1);
        // console.log(v2);
        // console.log(v3);
        // console.log(v4);
            ...
            <div className="containerDiv">
                ...
                <div className='inputForm'>
                    ...
                    <form onSubmit={onsubmits}>
                        <ColorBand key="1" heading="Digit 1" divId="color1Div" idBut1="col1" className="selectColor1" />
                        <ColorBand key="2" heading="Digit 2" divId="color2Div" idBut1="col2" className="selectColor2" />
                        <ColorBand key="3" heading="Multiplier" divId="color3Div" idBut1="col3" className="selectColor3" />
                        <ColorBand2 key="4" heading="Tolerance" divId="color4Div" className="selectColor4" />
                    </form>
                </div>
            </div>
            <div id='footer'>
                <a href="https://www.linkedin.com/in/rajat-agarwal-04b6b4194" target='_blank'>&#169; All Copyrights Reserved</a>
            </div>
        </>
    )
}

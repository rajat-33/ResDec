    ...
    return (
        <>
            <div onClick={changeColor} id={props.divId}>
                <h3>{props.heading}</h3>
                <button className={props.className} style={{ background: AllColors[10] }}>5%</button>
                <button className={props.className} style={{ background: AllColors[11] }}>10%</button>
                <button className={props.className} style={{ background: AllColors[12] }}>20%</button>
            </div>
        </>
    );
}
